    ...
    public void init(ServletConfig config) {
       ...
       // boolean bRet = mioDB.Connect("localhost", 3306, "gestione_scuola", "user_scuola", "scuola123");
        ...
        if (bRet) {
            ...
            System.out.println("Non ho connesso al db");
        }
    }
        ...
        if(Boolean.TRUE.equals(isAutorizzato)){//!!!
            try {
                if ("cerca".equals(submitAction)) {
                    ...
                    response.sendError(HttpServletResponse.SC_BAD_REQUEST, "Scelta non valida");
                }
            ...
            writer.println("window.location.href = '" + request.getContextPath() + "/index.html.html';");
            writer.println("</script>");
        }
